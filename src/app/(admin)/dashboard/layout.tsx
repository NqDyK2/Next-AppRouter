...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="flex flex-no-wrap">
            ...
            <div className="w-64 fixed sm:fixed bg-gray-800 shadow h-full flex-col justify-between hidden sm:flex">
                <div className="px-8">
                    ...
                    <div className="flex justify-center mt-[29rem] mb-4 w-full">
                        <div className="fixed">
            ...
            <div className=" mx-auto py-10 h-64 md:w-4/5 w-11/12 pr-6 pl-40">
